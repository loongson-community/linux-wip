...
void smp_prepare_boot_cpu(void)
{
	...
	for_each_possible_cpu(cpu) {
		 ...
		 *
		 * If possible cpus = present cpus here, numa_cpu_node
		 * will return valid node.
		 *
		 * If possible cpus > present cpus here (e.g. some possible
		 * cpus will be added by cpu-hotplug later), for possible
		 * but not present cpus, numa_cpu_node will return NUMA_NO_NODE,
